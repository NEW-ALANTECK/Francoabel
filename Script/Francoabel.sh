...
rm $HOME/THEVIX-PERU.sh
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL05FVy1BTEFOVEVDSy9GcmFuY29hYmVsL21haW4vQUFSQ0hJVk9T"
SUB_DOM='base64 -d'
...
funcao_idioma () {
 echo -e " "
msg -bar2
cowsay -f kiss "988808028 |generadores  Venta de droplets |" |lolcat
echo -e""
figlet Franco abel | lolcat
 echo -e " "
msg -bar2
...
echo -e " abel / ORO" && msg -verm "$(source trans -b pt:${id} "Reinicie su servidor para completar la instalación"|sed -e 's/[^a-z -]//ig')"
...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/alan1234578/kikeherramientas/main/trans &> /dev/null
msg -bar2
msg -ama "[ @Franco_abelcz ] [ V.8.4.3] ➣ \033[1;33m[\033[1;34m [OFICIAL] [whatsapp 988808028 ] \033[1;33m]"
[[ $1 = "" ]] && funcao_idioma || {
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "KEY INVALIDA!") ]]; then
   msg -bar2
   msg -ama "$(source trans -b pt:${id} "BEM VINDO, OBRIGADO POR UTILIZAR"|sed -e 's/[^a-z -]//ig'): \033[1;31m[988808028]"
   ...
   echo "${SCPdir}/menu" > /usr/bin/abel && chmod +x /usr/bin/abel
   inst_components
